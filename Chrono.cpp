...
void Date::add_month(int n)
{
	int num_years = n/12;
	n%=12;
	if((int)(m)+n < 1) //From Jan of this year to Dec of last year
	{
		m = (Month)(12); //set the month to Dec of this year
		num_years = -1; //Go back a year
	}
	else if ((int)(m)+n > 12) //From Dec of this year to Jan of next
	{
		m = (Month)(1); //set the month to Jan
		num_years = 1; //Go forward a year
	}
	else //any arbitrary month
	{
		m = (Month)((int)(m)+n);
	}
	add_year(num_years);
